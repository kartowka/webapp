...
const StudentDetails: React.FC<{ id: string; name: string; onItemSelect: (itemID: string) => void }> = ({ name, id, onItemSelect }) => {
	return (
		<TouchableOpacity
			onPress={() => {
				onItemSelect(id)
		...
		>
			<View style={StudentDetailsWrapper.container}>
				<Image source={require('@images/anonymous-icon-2.png')} style={StudentDetailsWrapper.avatar}></Image>
